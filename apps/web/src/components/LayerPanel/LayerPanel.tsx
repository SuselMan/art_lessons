...
export const LayerPanel = memo(function LayerPanel({
  ...
  const handleDelete = useCallback(async (ids?: string[]) => {
    ...
    if ([...idSet].some(hasLayerContent) && !await confirm({
      title: 'Delete layers',
      message: 'Delete the selected layer(s)? Any painted content on them — including content from other participants — will be lost.',
      confirmLabel: 'Delete',
      danger: true,
    })) return
  ...
  }, [activeId, selectedIds, layerState, onChange, onOp, hasLayerContent, confirm])
