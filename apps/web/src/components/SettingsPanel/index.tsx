  ...
  return (
    <div className={styles.backdrop} onClick={onClose}>
      <div className={styles.panel} onClick={e => e.stopPropagation()}>
        ...
        {/* Hotkeys (#174): the registry in lib/hotkeys.ts is the single
            source of truth — this list, the keydown handler in
            Room/index.tsx, and every tooltip that mentions a hotkey all
            read from it, so rebinding here actually takes effect
            everywhere at once (after Save's reload), not just here.
            Desktop-only, same as the shortcuts themselves (#173: no
            keyboard on touch devices). */}
        <div className={styles.sectionTitle}>Hotkeys</div>
        <div className={styles.flagList}>
