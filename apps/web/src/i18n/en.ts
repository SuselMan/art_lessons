...
export const en = {
  ...
  'settingsPage.theme': 'Appearance',
  'settingsPage.themeDark': 'Dark',
  'settingsPage.themeLight': 'Light (higher contrast)',
  'settingsPage.themeHint': 'Light is the more legible of the two — stronger text and clearly drawn edges. Taken from your system at first visit. Saved in this browser only.',
  ...
  'selection.delete': 'Delete contents',
  ...
  // sees it, so "press harder" can mean very different numbers on two
  // identical tablets. These strings walk someone through measuring their own.
  'editorSettings.tab.stylus': 'Pen',
  'pressure.rangeSection': 'Pen range',
  'pressure.notCalibrated': 'Not calibrated',
  'pressure.rangeValue': 'Calibrated: {min} to {max}',
  'pressure.rangeHint': 'If a firm press still draws a faint line, your pen reports only part of its range. Measuring it takes two strokes.',
  'pressure.calibrate': 'Calibrate\u2026',
  'pressure.recalibrate': 'Measure again\u2026',
  'pressure.resetRange': 'Reset',
  'pressure.reported': 'Pen reports',
  'pressure.curveSection': 'Response',
  'pressure.curve': 'Pressure response curve',
  'pressure.curveHint': 'How quickly the mark builds as you press. There is no right answer here \u2014 it depends on your grip and your hand.',
  'pressure.curveEditHint': 'Tap the graph to add a point, drag to shape it, drag a point off the graph to remove it.',
  'pressure.axisLight': 'Light press',
  'pressure.axisFirm': 'Firm press',
  'pressure.preset.softer': 'Softer',
  'pressure.preset.linear': 'Linear',
  'pressure.preset.firmer': 'Firmer',
  'pressure.wizard.step': 'Step {n} of 2',
  'pressure.wizard.lightPrompt': 'Draw a line with the lightest press you actually use.',
  'pressure.wizard.firmPrompt': 'Now a line with a firm press you can hold comfortably \u2014 not the hardest you can push.',
  'pressure.wizard.penOnly': 'Use the pen: a mouse has no pressure to measure.',
  'pressure.wizard.found': 'Measured. Your pen\u2019s working range will now cover the full response.',
  'pressure.wizard.foundLowCeiling': 'Found it: even a firm press never reaches the top of what your pen can report, which is why the line came out faint. Calibration fixes exactly this.',
  'pressure.wizard.lightLevel': 'Light press',
  'pressure.wizard.firmLevel': 'Firm press',
  'pressure.wizard.observedMax': 'Highest seen',
  'pressure.wizard.before': 'Now',
  'pressure.wizard.after': 'Calibrated',
  'pressure.wizard.again': 'Start over',
  'pressure.wizard.apply': 'Apply',
  'pressure.wizard.noRange': 'Both strokes came out at the same pressure. Either the pen reports none at all, or the two presses were the same \u2014 try again with a clearer difference.',
  'pressure.wizard.reversed': 'The second stroke was lighter than the first. The light one comes first, the firm one second.',
  'pressure.wizard.tooShort': 'That stroke was too short to measure. Draw a line across the strip, not a dot.',
  ...
  'hotkey.toggleSelection': 'Toggle select',
