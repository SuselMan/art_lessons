...
export const ru: Dictionary = {
  ...
  'settingsPage.theme': 'Оформление',
  'settingsPage.themeDark': 'Тёмное',
  'settingsPage.themeLight': 'Светлое (контрастнее)',
  'settingsPage.themeHint': 'Светлое — более разборчивое из двух: текст жирнее по тону, границы прорисованы явно. При первом заходе берётся из системных настроек. Сохраняется только в этом браузере.',
  'settingsPage.deviceType': 'Интерфейс',
  'settingsPage.deviceTablet': 'Планшет',
  'settingsPage.deviceDesktop': 'Компьютер',
  'settingsPage.compact': 'Раскладка для телефона',
  'settingsPage.compactAuto': 'По размеру экрана',
  'settingsPage.compactOn': 'Всегда',
  'settingsPage.compactOff': 'Никогда',
  'settingsPage.compactHint': 'На маленьком экране редактор показывает заметки и перо аннотаций вместо инструментов рисования, и один палец рисует, а два двигают холст. Само рисование остаётся на планшете и компьютере.',
  'settingsPage.version': 'Версия',
  'settingsPage.versionHint': 'Называйте её, когда сообщаете о проблеме, — она точно говорит, какая сборка стоит на этом устройстве.',
  'settingsPage.versionCheck': 'Проверить обновления',
  'settingsPage.versionChecking': 'Проверяем…',
  'settingsPage.versionCurrent': 'Установлена последняя версия',
  ...
  // (#460) Раздача ссылки — общие строки для ⋮ в списке уроков и меню в шапке
  ...
  'share.copiedInviteOnly':
    'Ссылка скопирована, но в проект входят только приглашённые. Остальным придётся попроситься и подождать.',
  'share.inviteOnly': 'В проект входят только приглашённые. Остальным придётся попроситься и подождать.',
  ...
  'join.password': 'Пароль',
  'join.passwordNeeded': 'Проект защищён паролем — введите его, чтобы войти.',
  ...
  'join.error.passwordRequired': 'Укажите пароль',
  ...
  'join.error.serverBusy': 'Сервер сейчас загружен. Подождите немного и попробуйте снова — ничего из вашего не потеряно.',
  ...
  'room.rotationLock': 'Зафиксировать поворот холста',
  'room.rotationUnlock': 'Снять фиксацию поворота',
  'room.rotationLockedHint': 'Поворот зафиксирован на {angle}°',
  ...
  'room.replayIncomplete': 'Часть проекта не удалось отрисовать на этом устройстве — вы видите не всё. Ничего не потеряно: обычно помогает открыть проект заново. До тех пор это устройство не будет сохранять для него превью и точки восстановления.',
  ...
  'room.restoreFailed.bodyDevice': 'Что-то пошло не так, пока проект собирался на этом устройстве, поэтому он пока не открыт — лучше так, чем показать вам пустой лист. Ничего не потеряно, всё хранится на сервере, а о сбое мы уже знаем.',
  ...
  // ── инструменты ────────────────────────────────────────────────────────
  'tool.drawing': 'Инструмент рисования',
  'tool.drawingTitle': '{tool} — ещё раз коснуться или задержать, чтобы выбрать другой',
  'tool.drawingTitlePencil':
    '{tool} ({hotkeys} — твёрже / мягче) — ещё раз коснуться или задержать, чтобы выбрать другой',
  ...
  'tool.eyedropperTitle': 'Пипетка — взять цвет с холста и вернуться к своему инструменту  {hotkey}',
  'tool.ruler': 'Линейка',
  'tool.rulerTitle': 'Линейка — потяните, чтобы задать грань; штрихи рядом с ней прилипают к линии и показывают расстояние  {hotkey}',
  ...
  'tool.fill': 'Заливка',
  'tool.shape': 'Фигура',
  'tool.shapeTitle': 'Фигура — выберите прямоугольник, эллипс, звезду или линию в настройках и растяните. Shift ограничивает, Alt рисует от центра. Enter применяет, Esc отменяет',
  // (#525) Четыре фигуры — варианты селектора, а не четыре инструмента.
  'tool.rectangle': 'Прямоугольник',
  'tool.rectangleTitle': 'Прямоугольник — растяните рамку; Shift держит квадрат, Alt рисует от центра. Enter применяет, Esc отменяет',
  'tool.ellipse': 'Эллипс',
  'tool.ellipseTitle': 'Эллипс — растяните рамку; Shift даёт круг, Alt рисует от центра. Сектор и кольцо — в настройках',
  'tool.polystar': 'Звезда',
  'tool.polystarTitle': 'Звезда — при нулевой звёздности это правильный многоугольник; число вершин задаётся в настройках',
  'tool.line': 'Линия',
  'tool.lineTitle': 'Линия — протяните от одного конца к другому; Shift привязывает угол',
  'tool.grid': 'Сетка',
  ...
  'room.annotationMode': 'Аннотации',
  'room.annotationModeTitle': 'Аннотации — меняет панель инструментов на заметки и перо аннотаций. Ничто здесь не трогает рисунок',
  ...
  'tool.field.eraseThroughLayers': 'Стирать сквозь слои',
  ...
  // Фигуры (#529).
  'tool.field.strokeColor': 'Обводка',
  'tool.field.strokeOn': 'Обводка',
  'tool.field.strokeWidth': 'Толщина обводки',
  'tool.field.strokeAlign': 'Положение обводки',
  'tool.strokeAlign.inside': 'Внутрь',
  'tool.strokeAlign.center': 'По центру',
  'tool.strokeAlign.outside': 'Наружу',
  'tool.field.fillColor': 'Заливка',
  'tool.field.fillOn': 'Заливка',
  'tool.field.cornerRadius': 'Скругление углов',
  'tool.field.strokeJoin': 'Углы',
  'tool.strokeJoin.miter': 'Острые',
  'tool.strokeJoin.round': 'Скруглённые',
  'tool.field.startAngle': 'Начальный угол',
  'tool.field.endAngle': 'Конечный угол',
  'tool.field.innerRadius': 'Внутренний радиус',
  'tool.field.closePath': 'Замыкать контур',
  'tool.field.points': 'Вершины',
  'tool.field.starness': 'Звёздность',
  'tool.field.rotation': 'Поворот',
  'tool.field.strokeCap': 'Концы',
  'tool.strokeCap.butt': 'Плоские',
  'tool.strokeCap.round': 'Круглые',
  'tool.strokeCap.square': 'Квадратные',
  'tool.field.snapAngle': 'Привязка угла',
  'room.shape.stroke': 'Цвет обводки',
  'room.shape.fill': 'Цвет заливки',
  'room.shape.swap': 'Поменять обводку и заливку',
  'room.shape.none': 'Без цвета',
  'room.shape.width': 'Ширина',
  'room.shape.height': 'Высота',
  'room.shape.ratio': 'Пропорции',
  'room.shape.ratioFree': 'Свободно',
  ...
  'tool.tiltResponse.smooth': 'Плавный',
  'tool.tiltResponse.linear': 'Линейный',
  'tool.pressureResponse.soft': 'Мягкий',
  'tool.pressureResponse.normal': 'Обычный',
  'tool.pressureResponse.firm': 'Жёсткий',
  ...
  'selection.delete': 'Удалить содержимое',
  ...
  'palette.slotHold': '{item} — удерживайте, чтобы изменить кнопку',
  'palette.slotEmpty': 'Пустая кнопка',
  'palette.slotEmptyHold': 'Пустая кнопка — удерживайте, чтобы положить инструмент',
  'palette.slotClear': 'Оставить пустой',
  'palette.roleDrawing': 'Последний рисующий',
  'palette.roleSecondary': 'Последний стирающий / растушёвка',
  ...
  'pressure.rangeSection': 'Диапазон пера',
  'pressure.notCalibrated': 'Не откалибровано',
  'pressure.rangeValue': 'Откалибровано: от {min} до {max}',
  'pressure.rangeHint': 'Если при сильном нажиме линия всё равно бледная \u2014 перо отдаёт только часть своего диапазона. Замер занимает два штриха.',
  'pressure.calibrate': 'Откалибровать\u2026',
  'pressure.recalibrate': 'Замерить заново\u2026',
  'pressure.resetRange': 'Сбросить',
  'pressure.reported': 'Перо отдаёт',
  'pressure.curveSection': 'Отклик',
  'pressure.curve': 'Кривая отклика на нажим',
  'pressure.curveHint': 'Насколько быстро набирается насыщенность при нажиме. Правильного ответа здесь нет \u2014 он зависит от хвата и руки.',
  'pressure.curveEditHint': 'Нажмите на график, чтобы добавить точку; тяните, чтобы менять форму; вытащите точку за пределы графика, чтобы убрать.',
  'pressure.axisLight': 'Лёгкий нажим',
  'pressure.axisFirm': 'Сильный нажим',
  'pressure.preset.softer': 'Мягче',
  'pressure.preset.linear': 'Линейно',
  'pressure.preset.firmer': 'Жёстче',
  'pressure.wizard.step': 'Шаг {n} из 2',
  'pressure.wizard.lightPrompt': 'Проведите линию самым лёгким нажимом, каким вы действительно рисуете.',
  'pressure.wizard.firmPrompt': 'Теперь линию сильным нажимом, который вам комфортно держать, \u2014 не изо всех сил.',
  'pressure.wizard.penOnly': 'Нужно перо: у мыши нечего мерить.',
  'pressure.wizard.found': 'Замерено. Рабочий диапазон вашего пера теперь покрывает весь отклик.',
  'pressure.wizard.foundLowCeiling': 'Нашли: даже сильный нажим не доходит до верха того, что перо способно отдать, \u2014 поэтому линия и выходила бледной. Калибровка чинит ровно это.',
  'pressure.wizard.lightLevel': 'Лёгкий нажим',
  'pressure.wizard.firmLevel': 'Сильный нажим',
  'pressure.wizard.observedMax': 'Максимум',
  'pressure.wizard.before': 'Сейчас',
  'pressure.wizard.after': 'После калибровки',
  'pressure.wizard.again': 'Заново',
  'pressure.wizard.apply': 'Применить',
  'pressure.wizard.noRange': 'Оба штриха вышли с одинаковым нажимом. Либо перо не отдаёт давление вовсе, либо нажим был одинаковым \u2014 попробуйте ещё раз с заметной разницей.',
  'pressure.wizard.reversed': 'Второй штрих оказался легче первого. Сначала лёгкий, потом сильный.',
  'pressure.wizard.tooShort': 'Штрих слишком короткий для замера. Проведите линию через всю полосу, а не точку.',
  ...
  'hotkey.toggleTransform': 'Переключить трансформацию',
  'hotkey.toggleGrid': 'Переключить инструмент «сетка»',
