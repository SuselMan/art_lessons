...
export const ru: Dictionary = {
  ...
  'tool.fill': 'Заливка',
  'tool.shape': 'Фигура',
  'tool.shapeTitle': '{shape} — растяните; ещё раз коснуться или задержать, чтобы выбрать другую. Shift ограничивает, Alt рисует от центра. Enter применяет, Esc отменяет',
  ...
  'palette.slotGroupHold': '{item} — ещё раз коснуться, чтобы выбрать другой; удерживать, чтобы изменить кнопку',
