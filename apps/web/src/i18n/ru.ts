...
export const ru: Dictionary = {
  ...
  'room.rotation': 'Поворот — щелчок поворачивает на 90°  ({hotkey} — сброс)',
  'room.rotateCCW': 'Повернуть на −15°  ({hotkey})',
  'room.rotateCW': 'Повернуть на +15°  ({hotkey})',
  ...
  'room.exportTransparent': 'Без фона',
  'room.exportTransparentTitle': 'Экспорт в PNG с прозрачным фоном',
  'room.saveSession': 'Сохранить',
  'room.saveSessionTitle': 'Сохранить сессию в JSON',
  'room.clearCanvas': 'Очистить холст',
  'room.confirmClear': 'Очистить активный слой? Действие можно отменить через {hotkey}.',
