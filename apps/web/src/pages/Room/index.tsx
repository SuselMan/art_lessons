...
export function Room() {
  ...
  // or nothing. Two of the entries are *roles* rather than tools — "whichever
  // drawing tool I last picked" and "whichever eraser/smudge/eyedropper I last
  // picked" — which is what the panel's fixed top and bottom slots already
  // were, and what the default layout still puts there. The panel resolves
  // them, so the two values below are all it needs to do it.
